...
-- Add allowed_categories column to stores
ALTER TABLE public.stores ADD COLUMN IF NOT EXISTS allowed_categories text[] DEFAULT NULL;

-- Update create_order_items_from_json to extract and store category
