...
|----------|-------|--------|
| Número do pedido | `text-xs` (12px) | `text-2xl font-bold` (24px) |
| Nome do produto/sabor | `font-semibold` (~16px) | `text-3xl font-bold` (30px) |
| Padding do card | `p-3` | `p-5` |

### Número do Pedido Maior (linha 207-209)
...
| Elemento | Antes | Depois |
|----------|-------|--------|
| Número do pedido (`#ML8X`) | 12px (`text-xs`) | 24px (`text-2xl font-bold`) |
| Nome do produto | ~16px (`font-semibold`) | 30px (`text-3xl font-bold`) |
| Padding do card | 12px (`p-3`) | 20px (`p-5`) |
| Layout | Grid 4 colunas | Coluna única centralizada |
